...
Route::prefix('v1')->name('api.v1.')->group(function () {
    ...
    Route::middleware(['auth.jwt'])->group(function () {
        ...
        // User repositories.
        Route::get('repositories/all', [UserRepositoryController::class, 'all']);
        Route::post(
            'repositories/{repository}/verify_connection',
            [UserRepositoryController::class, 'verifyConnection']
        );
        Route::apiResource('repositories', UserRepositoryController::class);
        ...
        Route::post('teams/{team}/resources/{resource}/publish', [
            TeamResourcesController::class, 'publish'
        ]);
