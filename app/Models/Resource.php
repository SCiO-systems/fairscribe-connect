...
class Resource extends Model
{
    ...
    public function repositories()
    {
        return $this->belongsToMany(
            ...
            'resource_id',
            'repository_id',
        )->withPivot('id', 'metadata', 'collection');
    }
    ...
    public function changeStatus($status)
    {
        ...
        if ($previous === ResourceStatus::UNDER_PREPARATION && $status !== $previous) {
            ...
            if ($piiFailingFilesCount > 0) {
                throw new Exception('Cannot send the resource for Review. The resource should have consent of meeting PII requirements for all files.');
            }
        }
