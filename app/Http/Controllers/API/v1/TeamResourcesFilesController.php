...
class TeamResourcesFilesController extends Controller
{
    ...
    public function store(CreateTeamResourceFileRequest $request, Team $team, Resource $resource)
    {
        ...
        if ($saved) {
            ...
            // TODO: Mark the file as failed only under flag RUN_PII_CHECKS
            $resourceFile->setPIIStatus(PIIStatus::FAILED);

            // Dispatch job for PII check.
            // TODO: Dispatch the following under an environment flag RUN_PII_CHECKS
